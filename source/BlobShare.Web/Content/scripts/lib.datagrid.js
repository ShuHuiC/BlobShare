...
DataGrid = function(container, schema, model, buildHeader) {
    ...
    // event listeners
    this.eventHandlers = {
        document_mouseup: this.document_mouseup.setScope(this),
        grid_td_rollover: this.grid_td_rollover.setScope(this),
        grid_td_rollout: this.grid_td_rollout.setScope(this),
        grid_td_click: this.grid_td_click.setScope(this),
        grid_input_keypress: this.grid_input_keypress.setScope(this),
        grid_td_command: this.grid_td_command.setScope(this),
        grid_th_click: this.grid_th_click.setScope(this),
        subgrid_created: this.subgrid_created.setScope(this),
        subgrid_rowedit: this.subgrid_rowedit.setScope(this),
        subgrid_rowedit_request: this.subgrid_rowedit_request.setScope(this),
        grid_specialField_focus: this.grid_specialField_focus.setScope(this),
        grid_specialField_blur: this.grid_specialField_blur.setScope(this)
    };
}
    ...
    for (var i = 0; i < this.schema.length; i++) {
        ...
        switch (colSchema.type) {
            ...
            case ("schema"):
                ...
                break;
            case ("custom"):
                if (typeof (colSchema.customContent) == "function") {
                    td.innerHTML = colSchema.customContent(dataItem);
                }
                else {
                    td.innerHTML = colSchema.customContent;
                }
                break;
            default:
                // label
    ...
    switch (schema.type) {
        ...
        case ("link"):
            ...
            if (schema.text)
                ...
                span.appendChild(document.createTextNode(dataItem[schema.propertyName]));
            ctrlBtn.appendChild(span);
            if (schema.linkUrl != undefined && typeof (schema.linkUrl) == "function") {
                ctrlBtn.href = schema.linkUrl(dataItem);
            } else {
