...
CD "%~dp0"
   ...
   ECHO ------------------------------------------------------------------
   PAUSE
   SET /P Install="Have you completed the Configuration.xml file successfully? This procedure will now deploy the 'Blob Share' sample Web application to Windows Azure. (Y/N): "
