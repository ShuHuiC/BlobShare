...
#{
#	CheckShouldBeEmpty "WindowsAzureStorage/StorageAccountName" $xml.Configuration.WindowsAzureStorage.StorageAccountName;
#	CheckShouldBeEmpty "WindowsAzureStorage/StorageAccountKey" $xml.Configuration.WindowsAzureStorage.StorageAccountKey;
#	CheckShouldBeEmpty "WindowsAzureStorage/StorageAccountLocation" $xml.Configuration.WindowsAzureStorage.StorageAccountLocation;
#}
...
function CheckAzureSettings()
{
	...
	CheckEmptyOrPlaceholder "sslCertificatePath" $xml.Configuration.sslCertificatePath;
	CheckEmptyOrPlaceholder "sslCertificatePassword" $xml.Configuration.sslCertificatePassword;
}

function CheckSmtp()
{	
	Write-Host "Verifying SMTP settings ...";
	
	CheckEmptyOrPlaceholder "SMTP/Host" $xml.Configuration.SMTP.Host;
	CheckEmptyOrPlaceholder "SMTP/Port" $xml.Configuration.SMTP.Port;
	CheckEmptyOrPlaceholder "SMTP/User" $xml.Configuration.SMTP.User;
	CheckEmptyOrPlaceholder "SMTP/Password" $xml.Configuration.SMTP.Password;
	CheckEmptyOrPlaceholder "SMTP/SenderName" $xml.Configuration.SMTP.SenderName;
	CheckEmptyOrPlaceholder "SMTP/SenderAddress" $xml.Configuration.SMTP.SenderAddress;
}
...
{   
	...
	CheckEmptyOrPlaceholder "BootstrapAdministratorSecret" $xml.Configuration.BootstrapAdministratorSecret;
