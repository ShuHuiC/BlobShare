...
IF EXIST "C:\Program Files\Microsoft SDKs\Windows Azure\.NET SDK\2012-06\ref\Microsoft.WindowsAzure.Diagnostics.dll" (
	copy "C:\Program Files\Microsoft SDKs\Windows Azure\.NET SDK\2012-06\ref\Microsoft.WindowsAzure.Diagnostics.dll" ..\WindowsAzureCmdlets\ /Y
) ELSE (
	echo ---------------------------------------------------------------------------------------------
	echo   The diagnostics assembly for the Windows Azure SDK 1.6 could not be found at "C:\Program Files\Microsoft SDKs\Windows Azure\.NET SDK\2012-06\ref\Microsoft.WindowsAzure.Diagnostics.dll"
	echo ---------------------------------------------------------------------------------------------
